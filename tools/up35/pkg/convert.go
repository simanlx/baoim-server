...
import (
	...
	mongoModel "BaoIM-Server/pkg/common/db/table/relation"
	mysqlModel "BaoIM-Server/tools/data-conversion/openim/mysql/v3"
	mongoModelRtc "BaoIM-Server/tools/up35/pkg/internal/rtc/mongo/table"
	mysqlModelRtc "BaoIM-Server/tools/up35/pkg/internal/rtc/mysql"
)
