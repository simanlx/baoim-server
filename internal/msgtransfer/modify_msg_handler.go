...
// 			notification := &extendmsg.ReactionMessageModifierNotification{}
...
// 				}
// 			} else {
// 				if err := mmc.extendMsgDatabase.InsertOrUpdateReactionExtendMsgSet(ctx, notification.ConversationID, notification.SessionType, notification.ClientMsgID, notification.MsgFirstModifyTime,
// mmc.extendSetMsgModel.Pb2Model(notification.SuccessReactionExtensions)); err != nil {
...
// 			// notification := &extendmsg.ReactionMessageDeleteNotification{}
// 			// if err := json.Unmarshal(msg.Content, notification); err != nil {
// 			// 	continue
// 			// }
// 			// if err := mmc.extendMsgDatabase.DeleteReactionExtendMsgSet(ctx, notification.ConversationID, notification.SessionType, notification.ClientMsgID, notification.MsgFirstModifyTime,
// mmc.extendSetMsgModel.Pb2Model(notification.SuccessReactionExtensions)); err != nil {
// 			// 	// log.NewError(operationID, "InsertOrUpdateReactionExtendMsgSet failed")
// 			// }
// 		}
