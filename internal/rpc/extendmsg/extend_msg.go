...
// func (m *msgServer) SetMessageReactionExtensions(ctx context.Context, req *extendmsg.SetMessageReactionExtensionsReq) (resp *extendmsg.SetMessageReactionExtensionsResp, err error) {
// 	resp = &extendmsg.SetMessageReactionExtensionsResp{}
...
// }
// func (m *msgServer) setKeyResultInfo(ctx context.Context, r *extendmsg.SetMessageReactionExtensionsResp, errCode int32, errMsg, clientMsgID, typeKey string, keyValue *extendmsg.KeyValue) {
// 	temp := new(extendmsg.KeyValueResp)
...
// }
// func (m *msgServer) setDeleteKeyResultInfo(ctx context.Context, r *extendmsg.DeleteMessagesReactionExtensionsResp, errCode int32, errMsg, clientMsgID, typeKey string, keyValue *extendmsg.KeyValue)
// {
// 	temp := new(extendmsg.KeyValueResp)
// 	temp.KeyValue = keyValue
// 	temp.ErrCode = errCode
...
// func (m *msgServer) GetMessagesReactionExtensions(ctx context.Context, req *extendmsg.GetMessagesReactionExtensionsReq) (resp *extendmsg.GetMessagesReactionExtensionsResp, err error) {
...
// func (m *msgServer) AddMessageReactionExtensions(ctx context.Context, req *extendmsg.ModifyMessageReactionExtensionsReq) (resp *extendmsg.ModifyMessageReactionExtensionsResp, err error) {
// 	return
// }

// func (m *msgServer) DeleteMessageReactionExtensions(ctx context.Context, req *extendmsg.DeleteMessagesReactionExtensionsReq) (resp *extendmsg.DeleteMessagesReactionExtensionsResp, err error) {
//log.Debug(req.OperationID, utils.GetSelfFuncName(), "m args is:", req.String())
